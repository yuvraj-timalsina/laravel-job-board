                ...
                @guest
                    <div class="flex mb-4">
                        <div class="flex-1 mx-2">
                            ...
                            <x-input class="block mt-1 w-full" id="email"
                                     type="email" name="email"
                                     :value="old('email')" required autofocus/>
                        </div>
                        <div class="flex-1 mx-2">
                            <x-label for="name" value="Full Name"/>
                            <x-input class=" block mt-1 w-full" id="name" type="text" name="name"
    ...
    <script>
        ...
        document.getElementById('form_submit').addEventListener('click', async (e) => {
            ...
            if (error) {
                ...
                // card is ok, create payment method id and submit the form
